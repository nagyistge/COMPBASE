...
/**
 * Provides the local service interface for UserLearningTemplateMap. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserLearningTemplateMapLocalServiceUtil
...
public interface UserLearningTemplateMapLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link UserLearningTemplateMapLocalServiceUtil} to access the user learning template map local service. Add custom service methods to {@link uzuzjmd.competence.assessment.service.impl.UserLearningTemplateMapLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
