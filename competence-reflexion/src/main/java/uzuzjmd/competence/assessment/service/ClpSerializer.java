...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "Competence-Reflexion-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "Competence-Reflexion";
            }
    ...
    public static Object translateInput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(ReflexionsAssessmentClp.class.getName())) {
    ...
    public static Object translateInputReflexionsAssessment(
        BaseModel<?> oldModel) {
        ReflexionsAssessmentClp oldClpModel = (ReflexionsAssessmentClp) oldModel;

        BaseModel<?> newModel = oldClpModel.getReflexionsAssessmentRemoteModel();
    ...
    public static Object translateOutputReflexionsAssessment(
        BaseModel<?> oldModel) {
        ReflexionsAssessmentClp newModel = new ReflexionsAssessmentClp();
