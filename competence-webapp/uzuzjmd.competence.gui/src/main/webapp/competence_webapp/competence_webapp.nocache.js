...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "competence_webapp" because\n';
  ...
  $wnd.__gwt_activeModules['competence_webapp'] = {
    'moduleName' : 'competence_webapp',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/competence_webapp.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['competence_webapp'].superdevmode = true;

  var expectedSuffix = '/competence_webapp.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + competence_webapp + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:competence_webapp';
  var devModeSessionKey = '__gwtDevModeSession:competence_webapp';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/competence_webapp/competence_webapp.nocache.js';
  ...
  $wnd.__gwt_activeModules['competence_webapp'].canRedirect = true;
  $wnd.__gwt_activeModules['competence_webapp'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING competence_webapp';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/competence_webapp?user.agent=' + ua + '&_callback=' + callback;
