...
public class DoConnectNodes extends DoNeo {
	...
	public DoConnectNodes(GraphDatabaseService graphDB, Index<Node> nodeIndex, Collection<String> graphNodes2, String toNode) {
	...
	public Graph doit() {
		...
		for (String nodeFrom : graphNodes) {
			...
			connectNodes(fromNode, toNode, " ", RelTypes.subclassOf);
		}
		return null;
	}
