...
public class GetCompetencesResponseReturn  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private uzuzjmd.service.competence.client.GetCompetencesResponseReturnDefinition[] definition;
    ...
    public GetCompetencesResponseReturn(
           ...
           uzuzjmd.service.competence.client.GetCompetencesResponseReturnDefinition[] definition,
     ...
     * @return definition
     */
    public uzuzjmd.service.competence.client.GetCompetencesResponseReturnDefinition[] getDefinition() {
        return definition;
    }
     ...
     * @param definition
     */
    public void setDefinition(uzuzjmd.service.competence.client.GetCompetencesResponseReturnDefinition[] definition) {
        this.definition = definition;
    }

    public uzuzjmd.service.competence.client.GetCompetencesResponseReturnDefinition getDefinition(int i) {
        return this.definition[i];
    }

    public void setDefinition(int i, uzuzjmd.service.competence.client.GetCompetencesResponseReturnDefinition _value) {
