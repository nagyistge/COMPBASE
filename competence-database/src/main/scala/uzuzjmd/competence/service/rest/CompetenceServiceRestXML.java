...
public class CompetenceServiceRestXML extends
     ...
     *                           filter
     * @param compulsory         flag whether only competences marked as compulsory should be
     *                           loaded
     * @param cache              can be either "cache" or "nocache"
    ...
    public Response addLearningTemplate(
        ...
        LearningTemplateValidation validator = new LearningTemplateValidation(learningTemplateResultSet);
        Boolean resultValid = validator.isValid();
