...
object Ont2CompetenceTree {
  ...
  val ontologyManager = new CompOntologyManager() //> org.apache.jena.atlas.lib.InternalErrorException: Invalid id node for subjec
                                                  ...
                                                  //| 	at com.hp.hpl.jena.util.iterator.WrappedIterator.next(WrappedIterator.ja
                                                  //| va:94)
                                                  //| 	at com.hp.hpl.jena.mem.TrackingTrip
