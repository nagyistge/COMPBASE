...
public class LinkEvidenceTab extends CompetenceTab {
	...
	public LinkEvidenceTab(LmsContextFactory contextFactory) {
		...
		if (Controller.contextFactory.getRole().equals("teacher")) {
			infoText = "Ordnen Sie die Aktivitäten aus dieser Site den Kompetenzen zu! Dies ermöglicht eine Übersicht über die erreichten Kompetenzen pro Teilnehmer.";
		} else {
			infoText = "Ordnen Sie die Aktivitäten dieser Site den Kompetenzen zu! Dies ermöglicht eine Übersicht über ihre erreichten Kompetenzen und die der anderen Teilnehmer. Das Häckchen bedeutet, dass die Kompetenzen für das Bestehen des Kurses verpflichtend sind!";
		}
