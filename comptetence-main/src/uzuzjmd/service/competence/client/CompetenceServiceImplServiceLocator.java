...
public class CompetenceServiceImplServiceLocator extends org.apache.axis.client.Service implements uzuzjmd.service.competence.client.CompetenceServiceImplService {
    ...
    public uzuzjmd.service.competence.client.CompetenceService getCompetenceServiceImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public uzuzjmd.service.competence.client.CompetenceService getCompetenceServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            uzuzjmd.service.competence.client.CompetenceServiceImplPortBindingStub _stub = new uzuzjmd.service.competence.client.CompetenceServiceImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (uzuzjmd.service.competence.client.CompetenceService.class.isAssignableFrom(serviceEndpointInterface)) {
                uzuzjmd.service.competence.client.CompetenceServiceImplPortBindingStub _stub = new uzuzjmd.service.competence.client.CompetenceServiceImplPortBindingStub(new java.net.URL(CompetenceServiceImplPort_address), this);
                _stub.setPortName(getCompetenceServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
