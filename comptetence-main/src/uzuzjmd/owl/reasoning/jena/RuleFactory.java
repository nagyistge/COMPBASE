...
//[operatorInverse2: (?a comp:CatchwordOf ?b) -> (?b comp:CatchwordOfInverse ?a)]
...
//					   (?a rdfs:domain ?learnerOf)]
							   ...
							   //[opinheritanceClassDOWN: (?a comp:CatchwordOf ?b) -> (?b comp:CatchwordOfInverse ?a)]
		
		
//inheritance for indviduals
//[opinheritenceUp: (?a comp:LearnerOf ?competence) (?competence rdfs:subClassOf ?c) notEqual(?c, owl:Thing) notEqual(?c, rdfs:Resource) 
//			 -> (?a comp:LearnerOf ?c)]					 
//[opinheritenceDOWN: (?a comp:LearnerOf ?competence) (?c rdfs:subClassOf ?competence) -> (?a comp:LearnerOf ?c)]