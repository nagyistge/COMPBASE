...
print "Files are integrated"
print "You can call the server with \"sudo service db-competence (start|status|stop)\""
print "For more information see: https://github.com/uzuzjmd/Wissensmodellierung"
